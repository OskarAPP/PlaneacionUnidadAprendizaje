...
/**
 * EvaluacionFinal generated by hbm2java
 */
public class EvaluacionFinal implements java.io.Serializable {
	...
	public EvaluacionFinal(Pua pua, String evaluacionFinal, Integer ponderacion) {
		this.pua = pua;
		this.evaluacionFinal = evaluacionFinal;
		this.ponderacion = ponderacion;
	}

	public Integer getIdEvaluacionFinal() {
		return this.idEvaluacionFinal;
	}

	public void setIdEvaluacionFinal(Integer idEvaluacionFinal) {
		this.idEvaluacionFinal = idEvaluacionFinal;
	}
